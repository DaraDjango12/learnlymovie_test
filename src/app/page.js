  ...
  return (
    <main className="flex min-h-screen  flex-col items-center p-24">
      ...
      <div className="flex flex-column md:flex-row justify-between my-8 gap-12">
        <div className=" rounded-[2rem] px-6 md:px-16 bg-[purple] text-[white] hover:bg-slate-400 py-4">
        <a href="/user/login" className="font-medium  text-gray-900">
              Login
            </a>
        </div>
        <div className=" rounded-[2rem] px-6 md:px-16 bg-[purple] hover:bg-slate-400 text-[white] py-4">
